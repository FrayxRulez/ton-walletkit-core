# Ton.WalletKit.Api.Model.TONTransactionTraceActionTONTransferDetails

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Comment** | **string** | Optional comment for the transfer | [optional] 
...
**IsEncrypted** | **bool** | Indicates if the payload or comment was encrypted. | [optional] 
